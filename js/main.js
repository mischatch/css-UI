 ...
 */
 ...
 $(document).ready(function(){
  $(window).on('scroll' , function(){
      ...
      var element_pos = $('.svg-animation').offset().top + $('.svg-animation').height() ;
